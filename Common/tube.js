...
{ 
	...
	//Add the upper base center.
    positions.push(0.0, 0.0, coreRatio);
	
	//Add the ring's upper inner base.
	for (i = 0; i < nSlices; ++i)
	{
        var theta = i * dTheta;
	...
	//Add the tube's upper inner edge.
	for (i = 0; i < nSlices; ++i)
	{
        var theta = i * dTheta;
        var x = tubeRatio * Math.cos(theta);
	...
	//Add the tube's lower inner edge.
	for (i = 0; i < nSlices; ++i)
	{
        var theta = i * dTheta;
        var x = tubeRatio * Math.cos(theta);
	...
	//Add the tube's lower inner base.
	for (i = 0; i < nSlices; ++i)
	{
        var theta = i * dTheta;
        var x = tubeRatio * Math.cos(theta);
